...
import com.example.moviedb.databinding.LoadStateFooterBinding

class SearchListItemLoadStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<SearchListItemLoadStateAdapter.LoadStateViewHolder>() {
